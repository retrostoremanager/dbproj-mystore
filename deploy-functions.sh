#!/bin/bash
# Deploy database functions to PostgreSQL
...
echo "Deploying database functions to $SERVER..."
echo "You will be prompted for the password: MyStore2024!SecurePass"

# Run the SQL file
PGPASSWORD="MyStore2024!SecurePass" psql "host=$SERVER port=5432 dbname=$DATABASE user=$USERNAME sslmode=require" << 'EOF'
