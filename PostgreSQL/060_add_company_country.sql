-- Issue #308: Add company_country to company profile
-- Adds the column and updates the get/update stored procedures to round-trip the value.

ALTER TABLE company ADD COLUMN IF NOT EXISTS company_country TEXT;

COMMENT ON COLUMN company.company_country IS 'Company country (free-text, e.g. "USA").';
