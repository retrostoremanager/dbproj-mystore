-- Issue #211: Add company_address2 (Address Line 2) to company profile
-- Adds the column and updates the get/update stored procedures.

ALTER TABLE company ADD COLUMN IF NOT EXISTS company_address2 TEXT;

COMMENT ON COLUMN company.company_address2 IS 'Company address line 2 (suite, unit, floor, etc.).';
